...
Если пользователь вводит число 1, то запустить демонстрационный режим.
Если пользователь вводит число 2, то запустить интерактивный режим.
Если пользователь вводит что-то другое, сказать, что нужно ввести 1 или 2, повторить шаг 1.
'''
def start():
    mode = input()
...
10. Если пользователь ввёл 5, то выйти из режима
